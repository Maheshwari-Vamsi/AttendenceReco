  ...
  implements SafeParcelable
{
    ...
    throws JSONException
  {
    ...
    for (Uri localUri = Uri.parse(str);; localUri = null) {
      return zza(zze.zzbI(localJSONObject.optString("providerId", null)), localJSONObject.optString("tokenId", null), localJSONObject.getString("email"), localJSONObject.optString("displayName", null), localUri, localJSONObject.getString("localId"), localJSONObject.optString("refreshToken")).zza(GoogleSignInAccount.zzbE(localJSONObject.optString("googleSignInAccount")));
    }
  }
...
/* Location:              D:\Apk\dex2jar-0.0.9.15\classes-dex2jar.jar!\com\google\android\gms\auth\api\signin\SignInAccount.class
