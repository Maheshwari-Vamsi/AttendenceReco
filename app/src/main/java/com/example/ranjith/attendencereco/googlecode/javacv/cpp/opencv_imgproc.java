...
@Properties({@com.googlecode.javacpp.annotation.Platform(include={"<opencv2/imgproc/imgproc_c.h>", "<opencv2/imgproc/imgproc.hpp>", "opencv_adapters.h"}, includepath={"/usr/local/include:/opt/local/include/"}, link={"opencv_imgproc@.2.4", "opencv_core@.2.4"}, linkpath={"/usr/local/lib/:/usr/local/lib64/:/opt/local/lib/:/opt/local/lib64/"}), @com.googlecode.javacpp.annotation.Platform(includepath={"C:/opencv/build/include/"}, link={"opencv_imgproc245", "opencv_core245"}, value={"windows"}), @com.googlecode.javacpp.annotation.Platform(linkpath={"C:/opencv/build/x86/vc10/lib/"}, preloadpath={"C:/opencv/build/x86/vc10/bin/"}, value={"windows-x86"}), @com.googlecode.javacpp.annotation.Platform(linkpath={"C:/opencv/build/x64/vc10/lib/"}, preloadpath={"C:/opencv/build/x64/vc10/bin/"}, value={"windows-x86_64"}), @com.googlecode.javacpp.annotation.Platform(includepath={"../include/"}, linkpath={"../lib/"}, value={"android"})})
public class opencv_imgproc
{
  ...
  @Namespace("cv")
  @NoOffset
  public static class BaseColumnFilter
    extends Pointer
  {
    static
    {
  ...
  @Namespace("cv")
  @NoOffset
  public static class BaseRowFilter
    extends Pointer
  {
    static
    {
  ...
  public static class CvChainPtReader
    extends opencv_core.CvSeqReader
  {
    static
    {
      Loader.load();
  ...
  public static class CvConnectedComp
    extends Pointer
  {
    static
    {
  ...
  @Opaque
  public static class CvContourScanner
    extends Pointer
  {
    static
    {
  ...
  public static class CvConvexityDefect
    extends Pointer
  {
    static
    {
  ...
  public static class CvDistanceFunction
  ...
  @Opaque
  public static class CvFeatureTree
    extends Pointer
  {
    static
    {
  ...
  public static class CvHistogram
    extends Pointer
  {
    static
    {
    ...
    {
      ReleaseDeallocator(CvHistogram paramCvHistogram)
      {
        super();
      }
  ...
  public static class CvHuMoments
    extends Pointer
  {
    static
    {
  ...
  public static class CvQuadEdge2D
    extends Pointer
  {
    static
    {
    ...
    {
      return (0xFFFFFFFFFFFFFFFC & paramLong) + (0x3 & paramLong + paramInt);
    }
    ...
    public CvSubdiv2DPoint cvSubdiv2DEdgeDst(@Cast({"CvSubdiv2DEdge"}) long paramLong)
    {
      return pt(0x3 & 2 + (int)paramLong);
    }
    
    public CvSubdiv2DPoint cvSubdiv2DEdgeOrg(@Cast({"CvSubdiv2DEdge"}) long paramLong)
    {
    ...
    public long cvSubdiv2DGetEdge(@Cast({"CvSubdiv2DEdge"}) long paramLong, @Cast({"CvNextEdgeType"}) int paramInt)
    {
      ...
      return (0xFFFFFFFFFFFFFFFC & l) + (0x3 & l + (paramInt >> 4));
    }
    ...
    public native CvQuadEdge2D pt(int paramInt, CvSubdiv2DPoint paramCvSubdiv2DPoint);
    
    public native CvSubdiv2DPoint pt(int paramInt);
  }
  
  public static class CvSubdiv2D
  ...
  public static class CvSubdiv2DEdge
    extends SizeTPointer
  {
    static
    {
      Loader.load();
  ...
  public static class CvSubdiv2DPoint
    extends Pointer
  {
    static
    {
    ...
    extends Pointer
  {
    ...
    public FilterEngine(@opencv_core.Ptr BaseFilter paramBaseFilter, @opencv_core.Ptr BaseRowFilter paramBaseRowFilter, @opencv_core.Ptr BaseColumnFilter paramBaseColumnFilter, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, @ByVal opencv_core.CvScalar paramCvScalar)
    {
    ...
    private native void allocate(@opencv_core.Ptr BaseFilter paramBaseFilter, @opencv_core.Ptr BaseRowFilter paramBaseRowFilter, @opencv_core.Ptr BaseColumnFilter paramBaseColumnFilter, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, @ByVal opencv_core.CvScalar paramCvScalar);
    ...
    public native FilterEngine columnFilter(BaseColumnFilter paramBaseColumnFilter);
    ...
    public native FilterEngine filter2D(BaseFilter paramBaseFilter);
    
    public native void init(@opencv_core.Ptr BaseFilter paramBaseFilter, @opencv_core.Ptr BaseRowFilter paramBaseRowFilter, @opencv_core.Ptr BaseColumnFilter paramBaseColumnFilter, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, @ByVal opencv_core.CvScalar paramCvScalar);
    ...
    public native FilterEngine rowFilter(BaseRowFilter paramBaseRowFilter);
  ...
  @Namespace("cv")
  public static class GeneralizedHough
    extends opencv_core.Algorithm
  {
    static
    {
  ...
  public static class IplConvKernel
    extends Pointer
  {
    static
    {
    ...
    static class ReleaseDeallocator
      extends IplConvKernel
      implements Pointer.Deallocator
    {
      ReleaseDeallocator(IplConvKernel paramIplConvKernel)
      {
        super();
      }
  ...
  public static class IplConvKernelFP
    extends Pointer
  {
    static
    {
...
/* Location:              D:\Apk\dex2jar-0.0.9.15\classes-dex2jar.jar!\com\googlecode\javacv\cpp\opencv_imgproc.class
