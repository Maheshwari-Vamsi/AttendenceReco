  ...
  implements SafeParcelable
{
  ...
  {
    if (paramLong == null) {
      paramLong = Long.valueOf(zzVs.currentTimeMillis() / 1000L);
    }
    return new GoogleSignInAccount(2, paramString1, paramString2, paramString3, paramString4, paramUri, null, paramLong.longValue(), zzx.zzcG(paramString5), new ArrayList((Collection)zzx.zzy(paramSet)));
  }
    ...
    throws JSONException
  {
    ...
    for (Uri localUri = Uri.parse(str);; localUri = null)
    {
      ...
      return zza(localJSONObject.optString("id"), localJSONObject.optString("tokenId", null), localJSONObject.optString("email", null), localJSONObject.optString("displayName", null), localUri, Long.valueOf(l), localJSONObject.getString("obfuscatedIdentifier"), localHashSet).zzbF(localJSONObject.optString("serverAuthCode", null));
    }
  }
...
/* Location:              D:\Apk\dex2jar-0.0.9.15\classes-dex2jar.jar!\com\google\android\gms\auth\api\signin\GoogleSignInAccount.class
