  ...
  implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener
{
  ...
  private void zze(boolean paramBoolean)
  {
    ...
    if (this.zzqW.zzDC.zzhC().zzcb())
    {
      ...
      this.zzqS.getLocationOnScreen(arrayOfInt);
      int i = zzl.zzcN().zzc(this.context, arrayOfInt[0]);
      int j = zzl.zzcN().zzc(this.context, arrayOfInt[bool]);
      if ((i != this.zzrs) || (j != this.zzrt))
      {
        this.zzrs = i;
        this.zzrt = j;
        localzzjo = this.zzqW.zzDC.zzhC();
        k = this.zzrs;
        m = this.zzrt;
        if (paramBoolean) {
          break label176;
    ...
    public void removeAllViews()
    {
      ...
      for (int i = 0; i < getChildCount(); i++)
      {
        ...
        if ((localView != null) && ((localView instanceof zzjn))) {
          localArrayList.add((zzjn)localView);
        }
      }
      super.removeAllViews();
      Iterator localIterator = localArrayList.iterator();
      while (localIterator.hasNext()) {
        ((zzjn)localIterator.next()).destroy();
      }
    }
...
/* Location:              D:\Apk\dex2jar-0.0.9.15\classes-dex2jar.jar!\com\google\android\gms\ads\internal\zzq.class
