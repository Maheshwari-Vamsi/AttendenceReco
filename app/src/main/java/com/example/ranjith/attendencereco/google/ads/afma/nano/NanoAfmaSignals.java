...
public abstract interface NanoAfmaSignals
{
    ...
    extends zztk
  {
    ...
    public static final int DEVICE_IDENTIFIER_NO_ID;
    ...
    protected int zzz()
    {
      int i = super.zzz();
      if (this.osVersion != null) {
        i += zztd.zzp(1, this.osVersion);
      }
      if (this.afmaVersion != null) {
        i += zztd.zzp(2, this.afmaVersion);
      }
      if (this.atvSignal != null) {
        i += zztd.zzd(3, this.atvSignal.longValue());
      }
      if (this.attSignal != null) {
        i += zztd.zzd(4, this.attSignal.longValue());
      }
      if (this.btsSignal != null) {
        i += zztd.zzd(5, this.btsSignal.longValue());
      }
      if (this.btlSignal != null) {
        i += zztd.zzd(6, this.btlSignal.longValue());
      }
      if (this.acxSignal != null) {
        i += zztd.zzd(7, this.acxSignal.longValue());
      }
      if (this.acySignal != null) {
        i += zztd.zzd(8, this.acySignal.longValue());
      }
      if (this.aczSignal != null) {
        i += zztd.zzd(9, this.aczSignal.longValue());
      }
      if (this.actSignal != null) {
        i += zztd.zzd(10, this.actSignal.longValue());
      }
      if (this.netSignal != null) {
        i += zztd.zzd(11, this.netSignal.longValue());
      }
      if (this.ornSignal != null) {
        i += zztd.zzd(12, this.ornSignal.longValue());
      }
      if (this.stkSignal != null) {
        i += zztd.zzp(13, this.stkSignal);
      }
      if (this.tcxSignal != null) {
        i += zztd.zzd(14, this.tcxSignal.longValue());
      }
      if (this.tcySignal != null) {
        i += zztd.zzd(15, this.tcySignal.longValue());
      }
      if (this.tctSignal != null) {
        i += zztd.zzd(16, this.tctSignal.longValue());
      }
      if (this.uptSignal != null) {
        i += zztd.zzd(17, this.uptSignal.longValue());
      }
      if (this.visSignal != null) {
        i += zztd.zzd(18, this.visSignal.longValue());
      }
      if (this.swzSignal != null) {
        i += zztd.zzd(19, this.swzSignal.longValue());
      }
      if (this.psnSignal != null) {
        i += zztd.zzd(20, this.psnSignal.longValue());
      }
      if (this.reqType != null) {
        i += zztd.zzd(21, this.reqType.longValue());
      }
      if (this.jbkSignal != null) {
        i += zztd.zzd(22, this.jbkSignal.longValue());
      }
      if (this.usgSignal != null) {
        i += zztd.zzd(23, this.usgSignal.longValue());
      }
      if (this.didSignal != null) {
        i += zztd.zzp(24, this.didSignal);
      }
      if (this.evtTime != null) {
        i += zztd.zzd(25, this.evtTime.longValue());
      }
      if (this.didSignalType != null) {
        i += zztd.zzI(26, this.didSignalType.intValue());
      }
      if (this.intSignal != null) {
        i += zztd.zzp(27, this.intSignal);
      }
      if (this.didOptOut != null) {
        i += zztd.zzc(28, this.didOptOut.booleanValue());
      }
      if (this.cerSignal != null) {
        i += zztd.zzp(29, this.cerSignal);
      }
      if (this.didSignalAndroidAdId != null) {
        i += zztd.zzp(30, this.didSignalAndroidAdId);
      }
      if (this.uwSignal != null) {
        i += zztd.zzd(31, this.uwSignal.longValue());
      }
      if (this.uhSignal != null) {
        i += zztd.zzd(32, this.uhSignal.longValue());
      }
      if (this.utzSignal != null) {
        i += zztd.zzd(33, this.utzSignal.longValue());
      }
      if (this.vnmSignal != null) {
        i += zztd.zzp(34, this.vnmSignal);
      }
      if (this.vcdSignal != null) {
        i += zztd.zzd(35, this.vcdSignal.longValue());
      }
      return i;
    }
  }
    ...
    extends zztk
  {
    ...
    protected int zzz()
    {
      int i = super.zzz();
      if (this.encryptedSpamSignals != null) {
        i += zztd.zzb(1, this.encryptedSpamSignals);
      }
      if (this.encryptedDidSignal != null) {
        i += zztd.zzb(2, this.encryptedDidSignal);
      }
      return i;
    }
  }
