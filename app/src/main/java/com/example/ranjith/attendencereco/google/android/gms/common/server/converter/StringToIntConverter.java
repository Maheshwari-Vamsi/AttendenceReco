  ...
  implements SafeParcelable, FastJsonResponse.zza<String, Integer>
{
  ...
  public String zzb(Integer paramInteger)
  {
    ...
    if ((str == null) && (this.zzakP.containsKey("gms_unknown"))) {
      str = "gms_unknown";
    }
    return str;
  }
...
/* Location:              D:\Apk\dex2jar-0.0.9.15\classes-dex2jar.jar!\com\google\android\gms\common\server\converter\StringToIntConverter.class
