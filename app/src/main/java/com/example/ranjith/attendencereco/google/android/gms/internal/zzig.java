  ...
  implements zzin.zzb
{
  ...
  public Bundle zza(Context paramContext, zzii paramzzii, String paramString)
  {
    ...
    synchronized (this.zzpK)
    {
      ...
      localBundle1.putBundle("app", this.zzJY.zzc(paramContext, paramString));
      localBundle2 = new Bundle();
      Iterator localIterator1 = this.zzKb.keySet().iterator();
      if (localIterator1.hasNext())
      {
        String str = (String)localIterator1.next();
        localBundle2.putBundle(str, ((zzij)this.zzKb.get(str)).toBundle());
      }
    }
    localBundle1.putBundle("slots", localBundle2);
    ArrayList localArrayList = new ArrayList();
    Iterator localIterator2 = this.zzKa.iterator();
    while (localIterator2.hasNext()) {
      localArrayList.add(((zzif)localIterator2.next()).toBundle());
    }
  ...
  public Future zza(Context paramContext, boolean paramBoolean)
  {
    synchronized (this.zzpK)
    {
      if (paramBoolean != this.zzIn)
      {
        ...
        Future localFuture = zzin.zza(paramContext, paramBoolean);
        return localFuture;
      }
      return null;
    }
...
/* Location:              D:\Apk\dex2jar-0.0.9.15\classes-dex2jar.jar!\com\google\android\gms\internal\zzig.class
